...
var cards_page = function () {
    ...
    this.assertAndfillCard = function (driver, val1, val2, val3, val4, MM, YY, CVV) {
        return driver.sleep(2000).elementById("ua.com.deltabank.pay2you:id/ll_pager").should.eventually.exist
            ...
            .elementById("ua.com.deltabank.pay2you:id/et_numbercard1").sendKeys(val2)
            .elementById("ua.com.deltabank.pay2you:id/et_numbercard1").sendKeys(val3)
            .elementById("ua.com.deltabank.pay2you:id/et_numbercard1").sendKeys(val4)
